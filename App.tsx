...
import { View, GeneratedContent, BrandVoice, WordPressConfig } from './types';
import { Sun, Moon, Bell, User, Search, Settings, Globe, Key, User as UserIcon, Link as LinkIcon, FileText, Layout } from 'lucide-react';
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white cursor-pointer"><User className="w-5 h-5" /></div>
          </div>
        </header>
