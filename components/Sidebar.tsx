...
import { LayoutDashboard, PenTool, FileText, Image as ImageIcon, BarChart, History, Settings, LogOut, Zap, Radio, Layers, Target, Network, RefreshCw, Layout } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: View.TOPIC_CLUSTERS, label: 'Programmatic SEO', icon: Network }, // New Item
  { id: View.COMPETITOR_ANALYSIS, label: 'Competitor Gap', icon: Target }, // New Item
  { id: View.SEO, label: 'SEO Analyzer', icon: BarChart }, // Renamed from SEO Tools
