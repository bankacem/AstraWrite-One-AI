      ...
      <div className="max-w-5xl mx-auto py-12 animate-in slide-in-from-bottom-12 duration-700">
        ...
        <div className="bg-white dark:bg-slate-800 p-16 md:p-32 rounded-[64px] shadow-2xl border border-slate-100 dark:border-slate-800">
           <article
             ...
             dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(activeArticle.content || '<div class="flex flex-col items-center gap-10 py-32"><Loader2 class="w-16 h-16 animate-spin text-indigo-600" /><p class="font-black text-3xl animate-pulse text-slate-400">Engineering article structure...</p></div>') }}
           />
        </div>
      </div>
    );
